package sjtxev.categories.services.implementations;
...
import sjtxev.categories.exceptions.ResourceNotFoundException;
import sjtxev.categories.payloads.CategoryDto;
import sjtxev.categories.repositories.CategoryRepository;
import sjtxev.categories.services.CategoryService;
import sjtxev.categories.services.ProductsClient;
...
public class CategoryServiceImplementations implements CategoryService {
	...
	public void deletSingleCategoryByCategoryId(Long categoryId) {
		...
		this.productsClient.deleteListOfProductsByCategoryId(categoryId);
	...
	@Override
	public List<Long> getListOfCategoryIdsByCategoryName(String categoryName) {
