...
import { ContactUsInquiryService } from "../../services/ContactUsInquiryService";
...
export default function ContactUsForm() {
  ...
  const handleCountryChange = (_, newValue) => {
    setData({
      ...
      mobileNumber: newValue?.phone ? `+${newValue.phone}` : "",
    });
  };
  ...
  const handleSubmit = (event) => {
    ...
    console.log(data);
    ContactUsInquiryService(data)
      .then((response) => {
        console.log(response);
        toast.success(
          "Form submitted successfully. The inquiry id is : " + response.contactUsId
        );
        redirect("/contact-us");
