package sjtxev.shipments.controllers;
...
import sjtxev.shipments.responseObjects.ApiResponse;
...
public class ShipmentController {
	...
	public Boolean existsSingleShipmentByShipmentIdAndCustomerId(@PathVariable("shipmentId") Long shipmentId,
			@PathVariable("customerId") Long customerId) {
		return this.shipmentService.existsSingleShipmentByShipmentIdAndCustomerId(shipmentId, customerId);
	}
