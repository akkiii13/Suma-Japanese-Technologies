package sjtxev.contact_us.controllers;
...
import sjtxev.contact_us.responseObjects.ApiResponse;
...
public class ContactUsController {
	...
	@GetMapping("/getSingleContactUsInquiryByCustomerIdAndContactUsId/customerId/{customerId}/contactUsId/{contactUsId}")
	public ResponseEntity<ContactUsDto> getSingleContactUsInquiryByCustomerIdAndContactUsId(
			@PathVariable("customerId") Long customerId, @PathVariable("contactUsId") Long contactUsId) {
		return new ResponseEntity<ContactUsDto>(
				this.contactUsService.getSingleContactUsInquiryByCustomerIdAndContactUsId(customerId, contactUsId),
				HttpStatus.OK);
	}
