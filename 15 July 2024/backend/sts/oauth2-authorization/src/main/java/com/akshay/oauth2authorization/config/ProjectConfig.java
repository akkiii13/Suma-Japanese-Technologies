package com.akshay.oauth2authorization.config;
...
//						.accessTokenFormat(OAuth2TokenFormat.REFERENCE)
	...
	public JWKSource<SecurityContext> jwkSource() throws NoSuchAlgorithmException {
		...
		RSAKey rsaKey = new RSAKey.Builder(rsaPublicKey).privateKey(rsaPrivateKey).keyID("BLABLABLA").build();
